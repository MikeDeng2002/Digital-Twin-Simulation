#!/bin/bash
# run_mini_batch_temp0_experiment.sh — Batch API runner for mini temp=0.0 experiment.
#
...
#   bash text_simulation/run_mini_batch_temp0_experiment.sh              # all 40
#   bash text_simulation/run_mini_batch_temp0_experiment.sh skill_v3     # one setting
#   bash text_simulation/run_mini_batch_temp0_experiment.sh skill_v3 high # one config
#
# Logs: text_simulation/logs/mini_batch_temp0/<config_name>.log
...
echo ""
echo "===== Mini Batch Temp0 Experiment Complete ====="
echo "  Total:     $TOTAL"
