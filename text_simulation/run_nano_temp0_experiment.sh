#!/bin/bash
# run_nano_temp0_experiment.sh — Runner for temp=0.0 deterministic experiment.
#
...
#   bash text_simulation/run_nano_temp0_experiment.sh              # all 40
#   bash text_simulation/run_nano_temp0_experiment.sh skill_v3     # one setting
#   bash text_simulation/run_nano_temp0_experiment.sh skill_v3 high # one config
#
# Logs: text_simulation/logs/nano_temp0/<config_name>.log
...
LOG_DIR="text_simulation/logs/nano_temp0"
mkdir -p "$LOG_DIR"
...
echo ""
echo "===== Nano Temp0 Experiment Complete ====="
echo "  Total:     $TOTAL"
